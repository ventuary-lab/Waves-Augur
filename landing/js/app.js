...
/* harmony import */ var smooth_scroll_dist_smooth_scroll_polyfills_min__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! smooth-scroll/dist/smooth-scroll.polyfills.min */ "./node_modules/smooth-scroll/dist/smooth-scroll.polyfills.min.js");
/* harmony import */ var smooth_scroll_dist_smooth_scroll_polyfills_min__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(smooth_scroll_dist_smooth_scroll_polyfills_min__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _navbar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./navbar */ "./src/js/navbar.js");
/* harmony import */ var _mark_dynamic__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mark-dynamic */ "./src/js/mark-dynamic.js");
...
var $sliders = $('.js-section-slider');

if ($sliders.length) {
  var goTo = function goTo() {
    var $th = $(this);
    var to = $th.data('to');
    var index = Number($th.attr('data-index'));
  ...
  $sliders.each(function (i) {
    var $th = $(this);
    var $slider = $th.find('.js-slider');
    var $controls = $th.find('.js-control');
    $controls.attr('data-index', i);
    var slider = $slider[0] ? Object(tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_2__["tns"])({
      "lazyload": false,
      "autoWidth": false,
      "items": 1,
      "gutter": 0,
    ...
    if (slider) {
      slider.events.on('indexChanged', function (v) {
        $(".js-control[data-index=\"".concat(i, "\"]")).removeClass('active');
        $(".js-control[data-index=\"".concat(i, "\"][data-to=\"").concat(v.index - 1, "\"]")).addClass('active');
      });
    }
...
var smoothScroll = new smooth_scroll_dist_smooth_scroll_polyfills_min__WEBPACK_IMPORTED_MODULE_3___default.a('a[href*="#"]', {
  speed: 1000,
  easing: 'easeInOutCubic',
  speedAsDuration: true
});
var smoothScrollMoment = new smooth_scroll_dist_smooth_scroll_polyfills_min__WEBPACK_IMPORTED_MODULE_3___default.a('a[href*="#"]', {
  speed: 100
});
...
if (document.getElementById('modal-guide-slider')) {
  nGS = Object(tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_2__["tns"])({
    "loop": false,
    "autoWidth": false,
    "autoHeight": false,
    "items": 1,
  ...
  nGS.events.on('indexChanged', function (v) {
    var $prev = $('.js-control-guide[data-to="prev"]');
    var $next = $('.js-control-guide[data-to="next"]');
    var $dismiss = $('.js-dismiss-guide');
  ...
  }, '.js-control-guide').on('click', '.js-dismiss-guide', function () {
    setTimeout(function () {
      nGS.goTo(0);
...
$(document).on('click', '.js-link--waves-keeper',
/*#__PURE__*/
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            _context.next = 3;
            return Object(_main__WEBPACK_IMPORTED_MODULE_1__["isUserAuthenticated"])();
...
Object(_navbar__WEBPACK_IMPORTED_MODULE_4__["default"])(smoothScrollMoment); // Хук для дизайнера, изменить анимацию можно вызвав в консоли markDynamic(1.4,1.4,2)

window.markDynamic = _mark_dynamic__WEBPACK_IMPORTED_MODULE_5__["default"];
Object(_mark_dynamic__WEBPACK_IMPORTED_MODULE_5__["default"])();
...
//     encrypted: true
// });
window.$ = window.jQuery = __webpack_require__(/*! ./jquery-3.4.1.slim.min */ "./src/js/jquery-3.4.1.slim.min.js");
window.Modal = __webpack_require__(/*! bootstrap/js/dist/modal */ "./node_modules/bootstrap/js/dist/modal.js"); // try {
...
/*!************************!*\
  !*** ./src/js/main.js ***!
  \************************/
/*! exports provided: isUserAuthenticated, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function isUserAuthenticated() {
  return _isUserAuthenticated.apply(this, arguments);
}

function _isUserAuthenticated() {
  _isUserAuthenticated = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
    var check, result, route, backendResponse, role;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            route = window.location.origin + '/api/v1/users/' + result.account.address;
            _context2.next = 10;
...
function checkIncomingParams() {
  ...
  var guideLink = url.searchParams.get('openGuide');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return markDynamic; });
function markDynamic() {
  var durationDefault = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1.4;
  var randomDurationStart = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1.4;
  var randomDurationEnd = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;
  ...
  function calcWorker(duration) {
    ...
    $marks.each(function (i) {
      var $th = $(this);
      var content = $th.text().trim();
      delay += duration;

      if (i > 1) {
        var r = randomIntFromInterval(duration * 0.75 * 10, duration * 0.95 * 10) / 10;
        delay -= r;
      }

      delay = Math.ceil(delay * 100) / 100;
      var $w = $th.find('.mark-dynamic__wrapper');
      ...
      if ($w.length) {
        ...
        $th.append("<span class=\"mark-dynamic__wrapper\" style=\"animation-duration: ".concat(duration, "s; animation-delay: ").concat(delay, "s;\"><span class=\"mark-dynamic__content\">").concat(content, "</span></span>"));
      }
    });
    delay += duration;
    play(function () {
...
function navbar(smoothScrollMoment) {
  ...
  var $themeSections = $('.js-section-theme');
  var $sectionLinks = $('.js-section-links');
  var themeSections = {};
  calcThSec();
  ...
  function calcThSec() {
    ...
    $themeSections.each(function () {
      var $th = $(this);
      var name = $th.data('theme');
      var $line = $th.find('.js-section-theme__line');
      themeSections[name] = {
        name: name,
        $elem: $th,
        $line: $line,
  ...
  function toggleTheme() {
    var st = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $(window).scrollTop();
    var themeSelected;
    var $line;
    var bottomWindowPosition = st + windowHeight;

    for (var theme in themeSections) {
    ...
    if (themeSelected) {
      ...
      var id = themeSelected.$elem.data('section-id');
      $sectionLinks.removeClass('active').filter("[href=\"#".concat(id, "\"]")).addClass('active');
    } else {
  ...
  var direction = 1; // direction === 1 - bottom, direction === -1 - top
  ...
  var $navFix = $('#navigation-fixed');
  var $nav = $('#section--fs__nav__wrapper');
  var offsetFromInvites = 23;
  var transition = 500; //.5s

  function calcFixedPosition($from, $to) {
    var pos = $from.offset(); // let posTop = pos.top - $(window).scrollTop();

    var posBottom = windowHeight - ($from.offset().top - $(window).scrollTop() + $from.height()); // let posLeft = pos.left;

    var posRight = $(window).width() - (pos.left + $from.width());
    $to.css({
      position: 'fixed',
      top: 'auto',
      left: 'auto',
  ...
  function toggleNavigation() {
    if ($(window).width() >= 576 && $nav.length) {
      var iTop = $invites.offset().top - offsetFromInvites;
      var nBottom = $nav.offset().top + $nav.height();
...
__webpack_require__(/*! /usr/local/var/www/ventuary-dao/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /usr/local/var/www/ventuary-dao/src/sass/app.scss */"./src/sass/app.scss");
